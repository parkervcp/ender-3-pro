 ...
 * Copyright (c) 2022 MarlinFirmware [https://github.com/MarlinFirmware/Marlin] // P-EDIT
 *
...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3 Pro/BigTreeTech SKR Mini E3 3.0" // P-EDIT
 ...
 */
#define USE_CONTROLLER_FAN // P-EDIT
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN FAN2_PIN       // Set a custom pin for the controller fan // P-EDIT
  ...
  #define CONTROLLER_FAN_EDITABLE         // Enable M710 configurable settings // P-EDIT
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // P-EDIT
...
#define COOLER_AUTO_FAN_PIN FAN_PIN // P-EDIT
...
#define HOMING_BUMP_MM      { 4, 4, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump // P-EDIT
...
// @section bltouch
  ...
  #define BLTOUCH_FORCE_SW_MODE // P-EDIT
...
#define DEFAULT_MINIMUMFEEDRATE             0.0     // (mm/s) Minimum feedrate. Set with M205 S. // P-EDIT
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_SCROLLING // P-EDIT
  ...
  #define LCD_SET_PROGRESS_MANUALLY // P-EDIT
...
// LCD Print Progress options
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY // P-EDIT
   ...
   */
  #define SDCARD_SORT_ALPHA // P-EDIT
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true  // Pre-allocate a static array for faster pre-sorting. // P-EDIT
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true  // Keep sorted items in RAM longer for speedy performance. Most expensive option. // P-EDIT
  ...
  #define UTF_FILENAME_SUPPORT  // P-EDIT

  #define LONG_FILENAME_HOST_SUPPORT      // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'  // P-EDIT
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES           // Scroll long filenames in the SD card menu  // P-EDIT
  ...
  #define AUTO_REPORT_SD_STATUS           // Auto-report media status with 'M27 S<seconds>'  // P-EDIT
   ...
   */
  #define SDCARD_CONNECTION ONBOARD  // P-EDIT
 ...
 */
#if ENABLED(SDSUPPORT) && DISABLED(NO_SD_HOST_DRIVE)  // P-EDIT
 ...
 */
#define EMERGENCY_PARSER  // P-EDIT
 ...
 */
#define ADVANCED_PAUSE_FEATURE // P-EDIT
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) // P-EDIT
  ...
  #define Z_HYBRID_THRESHOLD       20 // P-EDIT
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  72  // P-EDIT
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  70  // P-EDIT
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    #define Z_STALL_SENSITIVITY  10  // P-EDIT
    ...
    #define IMPROVE_HOMING_RELIABILITY  // P-EDIT
  #endif
 ...
 */
#define AUTO_REPORT_POSITION  // P-EDIT
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations  // P-EDIT
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others)  // P-EDIT
 ...
 */
#define HOST_ACTION_COMMANDS  // P-EDIT
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                  // Tell the host to pause in response to M76  // P-EDIT
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback  // P-EDIT
